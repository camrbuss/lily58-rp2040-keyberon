...
mod app {
    ...
    struct Shared {
        ...
        #[lock_free]
        debouncer: Debouncer<PressedKeys<6, 5>>,
    ...
    fn init(c: init::Context) -> (Shared, Local, init::Monotonics) {
        ...
        let matrix: Matrix<DynPin, DynPin, 6, 5> = cortex_m::interrupt::free(move |_cs| {
            Matrix::new(
                [
                    gpio21.into_pull_up_input().into(),
                    gpio23.into_pull_up_input().into(),
                ...
                [
                    ...
                    gpio8.into_push_pull_output().into(),
                    gpio9.into_push_pull_output().into(),
                ],
            )
        })
        .unwrap();
